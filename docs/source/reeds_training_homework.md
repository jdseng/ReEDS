...
3. Open the `cases_examples.csv` file
...
### 1. Create an informal slide deck
...
2. Open the `cases_examples.csv` file

3. Add a new column with 'Western_BA_Decarb' in row 1
   - Copy the contents of rows 2-6 from the ERCOT_county column
   - Replace 'z3109' with 'z132' in row 5 (`GSw_ZoneSet`)
   - Replace 'interconnect/texas' with 'interconnect/western' in row 4 (GSw_Region)
...
### 2. Create an informal slide deck
