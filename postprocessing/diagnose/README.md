...
Complex model like ReEDS has a larger number of equations and variables, which increases the size of matrix and RHS information. To limited the output size, `diagnose_process.py` has three switches to explicitly generate these reports. These switches, have default values of 0, are ;
