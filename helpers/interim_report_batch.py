...
functions (report.gms and report_dump.py) for a set of jobs 
with a common batch prefix, specified as a command line argument.
It will make new copies of report.gms/report_dump.py to 
...
report_files = ["report.gms", "report_dump.py"]
